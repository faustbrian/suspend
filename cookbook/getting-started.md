...
A flexible, context-aware suspension system for Laravel applications supporting entity-based and pattern-matched suspensions.

## Requirements

Suspend v1.0.0 requires PHP 8.4+ and Laravel 11+.
