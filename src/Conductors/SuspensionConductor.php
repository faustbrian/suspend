...
final class SuspensionConductor
{
    ...
    {
        return Suspension::query() // @phpstan-ignore return.type
            ->forContext($this->context) // @phpstan-ignore method.notFound
            ->active() // @phpstan-ignore method.nonObject
            ->get(); // @phpstan-ignore method.nonObject
    }
    ...
    public function all(): Collection
    {
        return Suspension::query() // @phpstan-ignore return.type
            ->forContext($this->context) // @phpstan-ignore method.notFound
            ->orderByDesc('suspended_at') // @phpstan-ignore method.nonObject
            ->get(); // @phpstan-ignore method.nonObject
    }
