...
describe('FastlyIpResolver', function (): void {
    beforeEach(function (): void {
        $this->resolver = new FastlyIpResolver();
    });

    describe('identifier', function (): void {
        it('returns fastly', function (): void {
            expect($this->resolver->identifier())->toBe('fastly');
        });
    });

    describe('resolve', function (): void {
        it('extracts IP from Fastly-Client-IP header', function (): void {
            $request = createRequestWithHeaders([
                'Fastly-Client-IP' => '203.0.113.50',
            ]);
