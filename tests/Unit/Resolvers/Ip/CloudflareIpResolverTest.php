...
describe('CloudflareIpResolver', function (): void {
    beforeEach(function (): void {
        $this->resolver = new CloudflareIpResolver();
    });

    describe('identifier', function (): void {
        it('returns cloudflare', function (): void {
            expect($this->resolver->identifier())->toBe('cloudflare');
        });
    });

    describe('resolve', function (): void {
        it('extracts IP from CF-Connecting-IP header', function (): void {
